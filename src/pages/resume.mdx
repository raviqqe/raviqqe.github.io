...
A senior software engineer enthusiastic about programming languages themselves. Equipped with production-level knowledge about Rust, Go, and TypeScript, low-layer programming, and Clean Architecture.
