...
A senior software engineer enthusiastic about programming languages themselves. Equipped with production-level knowledge about Rust, Go, and TypeScript, low-layer programming, and [Clean Architecture](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html).
...
- Design and implementation of Prometheus/Grafana telemetry stack on a Kubernetes cluster.
...
- Development using TypeScript, Node.js, Scala, HashiCorp Configuration Language, and shell scripts for projects listed above.
...
- Development of Deep Learning models of language model and voice recognition, Python, [TensorFlow][tensorflow], TypeScript, React Native, [GraphQL][graphql], and Firebase/Google Cloud Platform.
...
- Analysis on smoothness of cut surfaces with certain materials and cutting edges using the simulator.
