...
A senior software engineer equipped with production-level knowledge about Rust, Go, Scala, TypeScript, Node.js, low-layer programming, and [Clean Architecture](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html). Enthusiastic about programming languages and their implementations.
...
- Development of a routing system for electric vehicles.
- Development of a navigation guidance system.
  - Development of a lane guidance component in the system
