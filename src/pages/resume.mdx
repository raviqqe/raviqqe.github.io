...
A senior software engineer equipped with production-level knowledge about Rust, Go, Scala, and TypeScript, low-layer programming, and [Clean Architecture](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html). Enthusiastic about programming languages and their implementations.
