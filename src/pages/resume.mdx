...
A senior software engineer enthusiastic about programming languages themselves. Equipped with production-level knowledge of Rust, Go, and TypeScript and low-layer programming.
